...
def analysis():
    ...
    verify_dir = 'C:/Users/prasanth/Desktop/SOURCE CODE/testpicture'
    IMG_SIZE = 50
    LR = 1e-3
...
def openphoto():
    dirPath = "C:/Users/prasanth/Desktop/SOURCE CODE/testpicture"
    fileList = os.listdir(dirPath)
    for fileName in fileList:
        os.remove(dirPath + "/" + fileName)
    
    fileName = askopenfilename(initialdir='C:/Users/prasanth/Desktop/SOURCE CODE/test/test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:/Users/prasanth/Desktop/SOURCE CODE/testpicture"
